...
class CategoriasController
{
    ...
    static async indexGet(req, res) {
        let data = await categorias.consultar();
        res.send(data);
    }
    ...
    static async indexPost(req, res) {
        try {
            ...
            const insertedId = await categorias.insertar(newData);
    ...
    static async itemGet(req, res) {
        ...
        let data = await categorias.consultarPorId(id);
        if (data.length == 0) {
    ...
    static async itemPut(req, res) {
        try {
            ...
            const result = await categorias.reemplazar(id, updatedData);
    ...
    static async itemPatch(req, res) {
        try {
            ...
            const result = await categorias.actualizar(id, updatedFields);
